...
import main.Java.MiniPaginas.IngredientesFrameCatupiry;
import main.Java.MiniPaginas.IngredientesFrameEpic;
import main.Java.MiniPaginas.IngredientesFramePicanha;
import main.Java.MiniPaginas.IngredientesFrameTruffled;
import main.Java.Util.Muda;


public class Burges extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton9.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/Java/imagem/1.jpeg"))); // NOI18N
        ...
        jButton11.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/Java/imagem/2.jpeg"))); // NOI18N
        ...
        jLabel2.setText("Epic Cheddar Burger");
        ...
        jButton12.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/Java/imagem/3.jpeg")));
        ...
        jButton10.setIcon(new javax.swing.ImageIcon(getClass().getResource("/main/Java/imagem/4.jpeg"))); // NOI18N
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        IngredientesFramePicanha ingredientesFramePicanha = new IngredientesFramePicanha();
        ingredientesFramePicanha.setVisible(true);
    }                                         

    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {                                         
      
        IngredientesFrameTruffled ingredientesFrameTruffled = new IngredientesFrameTruffled();
        ingredientesFrameTruffled.setVisible(true);
    }     
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {                                         
        IngredientesFrameCatupiry ingredientesFrameCatupiry = new IngredientesFrameCatupiry();
        ingredientesFrameCatupiry.setVisible(true);
    }           
    private void jButton11ActionPerformed(java.awt.event.ActionEvent evt) {                                          
        IngredientesFrameEpic ingredientesFrameEpic = new IngredientesFrameEpic();
        ingredientesFrameEpic.setVisible(true);
    }
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Burges.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
