...
public class IngredientesFrameEpic extends JFrame {
    ...
    public IngredientesFrameEpic() {
        initComponents();
        setTitle("Ingredientes - Epic Cheddar Burger");
        setSize(600, 400);
    ...
    private void initComponents() {
        ...
        label2 = new JLabel("- queijo tipo ementhal e molho cheddar");
        label3 = new JLabel("- bacon crocante");
        label4 = new JLabel("- Smoked Mayo");
        label5 = new JLabel("- cebolas caramelizadas");
        label6 = new JLabel("- pão tipo brioche");
        ...
        saveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                salvarIngredientes("Epic Cheddar Burger");
                dispose();
            }
        });
    ...
    private void salvarIngredientes(String nomeUsuario) {
        ...
        if (ingredientCount2 > 0) {
            ingredientList.add("queijo tipo ementhal e molho cheddar: " + ingredientCount2);
        }
        if (ingredientCount3 > 0) {
            ingredientList.add("bacon crocante: " + ingredientCount3);
        }
        if (ingredientCount4 > 0) {
            ingredientList.add("Smoked Mayo: " + ingredientCount4);
        }
        if (ingredientCount5 > 0) {
            ingredientList.add("cebolas caramelizadas: " + ingredientCount5);
        }
        if (ingredientCount6 > 0) {
            ingredientList.add("pão tipo brioche: " + ingredientCount6);
        }
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(new Runnable() {
            public void run() {
                new IngredientesFrameEpic().setVisible(true);
            }
        });
    }
}
