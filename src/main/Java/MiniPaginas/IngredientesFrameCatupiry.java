...
public class IngredientesFrameCatupiry extends JFrame {
    ...
    public IngredientesFrameCatupiry() {
        initComponents();
        setTitle("Ingredientes - Catupiry Madness Burger");
        setSize(600, 400);
    ...
    private void initComponents() {
        ...
        label2 = new JLabel("- Catupiry® empanado");
        label3 = new JLabel("- maionese verde Outback");
        label4 = new JLabel("- Smoked Mayo");
        label5 = new JLabel("- picles de cebola roxa");
        ...
        saveButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                salvarIngredientes("Catupiry Madness Burger");
                dispose();
            }
        });
    ...
    private void salvarIngredientes(String nomeUsuario) {
        ...
        if (ingredientCount2 > 0) {
            ingredientList.add("Catupiry® empanado: " + ingredientCount2);
        }
        if (ingredientCount3 > 0) {
            ingredientList.add("maionese verde Outback: " + ingredientCount3);
        }
        if (ingredientCount4 > 0) {
            ingredientList.add("Smoked Mayo: " + ingredientCount4);
        }
        if (ingredientCount5 > 0) {
            ingredientList.add("picles de cebola roxa: " + ingredientCount5);
        }
        if (ingredientCount6 > 0) {
